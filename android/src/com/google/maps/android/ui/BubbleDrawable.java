...
class BubbleDrawable extends Drawable {
	...
	/*
	 * public BubbleDrawable(Resources res) { // mMask =
	 * res.getDrawable(R.drawable.amu_bubble_mask); // mShadow =
	 * res.getDrawable(R.drawable.amu_bubble_shadow); }
	 */
	...
	public boolean getPadding(Rect padding) {
		return false; // return mMask.getPadding(padding);
	}
}
