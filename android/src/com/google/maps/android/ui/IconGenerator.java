...
public class IconGenerator {
	...
	public IconGenerator(Context context) {
		...
		// TODO mContainer = (ViewGroup)
		// LayoutInflater.from(mContext).inflate(R.layout.amu_text_bubble,
		// null);
		mRotationLayout = (RotationLayout) mContainer.getChildAt(0);
		// TODO mContentView = mTextView = (TextView)
		// mRotationLayout.findViewById(R.id.amu_text);
	...
	public void setContentView(View contentView) {
		...
		// TODO final View view = mRotationLayout.findViewById(R.id.amu_text);
	...
	private static int getTextStyle(int style) {
		return 1;/*
				 * switch (style) { default: // case STYLE_DEFAULT: // case
				 * STYLE_WHITE: // return
				 * R.style.amu_Bubble_TextAppearance_Dark; case STYLE_RED: case
				 * STYLE_BLUE: case STYLE_GREEN: case STYLE_PURPLE: // case
				 * STYLE_ORANGE: // return
				 * R.style.amu_Bubble_TextAppearance_Light; }
				 */
	}
}
